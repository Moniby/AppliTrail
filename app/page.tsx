...
export default async function LandingPage() {
  ...
  return <main className="landing-page">
    <nav className="landing-nav"><a className="landing-brand" href="/"><AppliTrailLogo />AppliTrail</a><div><a href="#pricing">Pricing</a><a href="#faq">FAQ</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a>{user?<a className="landing-signin" href="/app">Open dashboard</a>:<a className="landing-signin" href="/signin">Sign in</a>}</div></nav>
