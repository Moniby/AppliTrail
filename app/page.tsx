...
const frequentlyAskedQuestions = [
  ...
  {
    question: "Can I save a job directly from a job board?",
    answer: "Yes. Install the AppliTrail Job Importer for Chrome or Microsoft Edge, open a job advertisement and choose Capture & review in AppliTrail. The posting is opened as a draft for your review; it is not saved or submitted until you confirm it.",
  },
  {
...
export default async function LandingPage() {
  ...
  return <main className="landing-page">
    <nav className="landing-nav"><a className="landing-brand" href="/"><AppliTrailLogo />AppliTrail</a><div><a href="#pricing">Pricing</a><a href="/extension">Browser extension</a><a href="#faq">FAQ</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a>{user?<a className="landing-signin" href="/app">Open dashboard</a>:<a className="landing-signin" href="/signin">Sign in</a>}</div></nav>
    ...
    <footer className="landing-footer"><span>© {new Date().getFullYear()} Tompris Technologies Inc. All rights reserved.<small>AppliTrail is a product of Tompris Technologies Inc.</small></span><div><a href="/extension">Browser extension</a><a href="#faq">FAQ</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a></div></footer>
  </main>;
}
