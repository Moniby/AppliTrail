...
export default function ExtensionPage(){return <main className="extension-page">
  ...
  <section className="extension-hero"><div><p className="eyebrow">BROWSER EXTENSION · ALL PLANS · BETA · VERSION 1.2.0</p><h1>Save a job ad without starting from scratch.</h1><p>Capture an open job posting, review every extracted detail, and save it to your own AppliTrail account when you are ready.</p><p>The extension is included with Free, Basic and Standard. Every imported job counts toward your plan’s normal application limit.</p><div className="extension-hero-actions"><a className="landing-primary" href="/applitrail-job-importer-v1.2.0.zip" download>Download for Chrome &amp; Edge</a><a href="#install">View installation steps</a></div><small>The beta uses your browser’s Developer mode. Already installed? Download version 1.2.0, replace the files in your extension folder, then select Reload on your browser’s extensions page.</small></div><aside><span>WHAT IT CAPTURES</span><ul><li>Company and job title</li><li>Job description and original link</li><li>Location and work arrangement where available</li><li>Position type and salary where published</li></ul><strong>You review everything before it is saved.</strong></aside></section>
  ...
  <footer className="landing-footer"><span>© {new Date().getFullYear()} Tompris Technologies Inc. All rights reserved.<small>AppliTrail is a product of Tompris Technologies Inc.</small></span><div><a href="/privacy">Privacy</a><a href="/terms">Terms</a></div></footer>
 </main>}
