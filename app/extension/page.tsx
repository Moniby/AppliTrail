...
export default function ExtensionPage(){return <main className="extension-page">
  ...
  <section className="extension-hero"><div><p className="eyebrow">BROWSER EXTENSION · BETA</p><h1>Save a job ad without starting from scratch.</h1><p>Capture an open job posting, review every extracted detail, and save it to your own AppliTrail account when you are ready.</p><div className="extension-hero-actions"><a className="landing-primary" href="/applitrail-job-importer.zip" download>Download for Chrome &amp; Edge</a><a href="#install">View installation steps</a></div><small>The beta uses your browser’s Developer mode. A one-click store installation will follow after Chrome and Edge store approval.</small></div><aside><span>WHAT IT CAPTURES</span><ul><li>Company and job title</li><li>Job description and original link</li><li>Location and work arrangement where available</li><li>Position type and salary where published</li></ul><strong>You review everything before it is saved.</strong></aside></section>
